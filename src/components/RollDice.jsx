...
const RollDice = ({activeDice, handleDiceClick, randomNumberGenerator, setTotalScore}) => {
    const diceImages = [null, dice1, dice2, dice3, dice4, dice5, dice6];
    const [showRules, setShowRules] = useState(false);
  return (
    <div className={styles.container}>
      <div className={styles.dice}>
        <img src={diceImages[activeDice]} alt={`Dice ${activeDice}`} 
      ...
      <div className={styles.buttonContainer}>
        ...
        <button className={styles.showRulesButton} onClick={() => setShowRules(true)}>Show Rules</button>
      </div>
